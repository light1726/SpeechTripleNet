...
def logf0(y, lower_f0, upper_f0, sample_rate, frame_shift_sample):
    x = y / max(abs(y)) * 32768.0
    f0 = pysptk.sptk.rapt(x, sample_rate, hopsize=frame_shift_sample,
                          min=lower_f0, max=upper_f0, otype='f0')
